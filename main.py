...
def main():
    ...
    if st.session_state.get("audio_to_play"):
        ...
        # chatgpt
    # st.write("Audio exists:", bool(st.session_state.get("audio_to_play")))
    # st.write("Audio size:", len(st.session_state.audio_to_play) if st.session_state.get("audio_to_play") else 0)
